...
class IngredientService {
    ...
    static let chickenBreast = Ingredient(name: "Chicken Breast", weight: 150, needsCooking: true, isVegetarian: false, image: #imageLiteral(resourceName: "chicken").jpegData(compressionQuality: 0.5) ?? Data())
